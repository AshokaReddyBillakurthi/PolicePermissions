...
public interface AppConstents {
    ...
    String MY_COMPLAINTS = "My Applied Services";
    String ADMIN = "Admin";
    ...
    //Areas
    String GACHIBOWLLI = "Gachibowlli";
    String MADHAPUR    = "Madhapur";
    String KONDAPUR    = "Kondapur";
    String AMEERPET    = "Ameerpet";
    String HITECH      = "Hi-Tech City";
