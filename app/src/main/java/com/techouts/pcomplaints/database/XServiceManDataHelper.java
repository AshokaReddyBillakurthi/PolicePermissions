...
public class XServiceManDataHelper {
    ...
    public static void insertUserData(Context context,ArrayList<ExServiceMan> exServiceManList){
        ...
        try{
            ...
            String insertQuery = "Insert into tblXServiceMans(firstName,lastName,email,password,mobileNo,state," +
                    "district,subDivision,circlePolicestation,userImg,userType,services,reqDocs,status) " +
                    " values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            ...
            if(null!= exServiceManList&&!exServiceManList.isEmpty()){
                for(ExServiceMan exServiceMan: exServiceManList){
                    ...
                    insertStmt.bindString(7,exServiceMan.district);
                    insertStmt.bindString(8,exServiceMan.subDivision);
                    insertStmt.bindString(9,exServiceMan.circlePolicestation);
                    insertStmt.bindString(10,exServiceMan.userImg);
                    insertStmt.bindString(11,exServiceMan.userType);
                    insertStmt.bindString(12,exServiceMan.services);
                    insertStmt.bindString(13,exServiceMan.reqDocs);
                    insertStmt.bindString(14,exServiceMan.status+"");
        ...
        try{
            ...
            if(null!=cursor&&cursor.moveToFirst()){
                do{
                    ...
                    xServiceMan.district = cursor.getString(5);
                    xServiceMan.subDivision = cursor.getString(6);
                    xServiceMan.circlePolicestation = cursor.getString(7);
                    xServiceMan.userImg = cursor.getString(8);
                    xServiceMan.userType = cursor.getString(9);
                    xServiceMan.services = cursor.getString(10);
                    xServiceMan.reqDocs = cursor.getString(11);
                    xServiceMan.status = Integer.parseInt(cursor.getString(12));
